 ...
 * @author ASUS
 */
public class addOt extends javax.swing.JDialog {
    Connection conn;
    PreparedStatement pst;
    ResultSet rs;
    /**
     * Creates new form addOt
     */
    public addOt(javax.swing.JDialog parent, boolean modal, String last, String first, String ids,String date, String logi,String logo) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int p = JOptionPane.showConfirmDialog(null, "Are you sure you want to Add This OverTime Record of this Employee?","Add Record",JOptionPane.YES_NO_OPTION);
        if(p == 0){
            if(!an.isSelected() && !al.isSelected() || st.getSelectedItem().toString().equals("Select")){
                ...
                try{
                    conn = db.db();
                    pst = conn.prepareStatement("insert payroll_schema.overtime_tbl values (?,?,?,?,?,?,?,'Recorded',?);");
                    pst.setString(1,id.getText());
                    pst.setString(2,ln.getText());
                    pst.setString(3,fn.getText());
                    pst.setString(4,twh.getText());
                    pst.setString(5,st.getSelectedItem().toString());
                    pst.setString(6,otti.getText());
                    pst.setString(7,otto.getText());
                    pst.setString(8,dt.getText());
                    pst.execute();
                ...
                try{
                    conn = db.db();
                    pst = conn.prepareStatement("insert payroll_schema.overtime_tbl values (?,?,?,?,?,?,?,'Not Yet Recorded',?);");
                    pst.setString(1,id.getText());
                    pst.setString(2,ln.getText());
                    pst.setString(3,fn.getText());
                    pst.setString(4,twh.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addOt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                addOt dialog = new addOt(new javax.swing.JDialog(), true, null,null,null,null,null,null);
