 ...
 * @author ASUS
 */
public class addphilhealthbracket extends javax.swing.JDialog {
    Connection conn;
    PreparedStatement pst;
    ResultSet rs;
    Properties prop = new Properties();
    /**
     * Creates new form addphilhealthbracket
     */
    public addphilhealthbracket(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Add PhilHealth Bracket");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addphilhealthbracket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                addphilhealthbracket dialog = new addphilhealthbracket(new javax.swing.JDialog(), true);
