 ...
 * @author ASUS
 */
public class addSSSBracket extends javax.swing.JDialog {
    Connection conn;
    PreparedStatement pst;
    ResultSet rs;
    /**
     * Creates new form AddSSSBracket
     */
    public addSSSBracket(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addSSSBracket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                addSSSBracket dialog = new addSSSBracket(new javax.swing.JDialog(), true);
