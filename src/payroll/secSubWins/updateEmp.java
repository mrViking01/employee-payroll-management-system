...
public class updateEmp extends javax.swing.JDialog {
     ...
     */
    public updateEmp(javax.swing.JDialog parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        empln.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                emplnActionPerformed(evt);
            }
        });
        ...
        piid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                piidActionPerformed(evt);
            }
        });
        ...
        nameicoe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nameicoeActionPerformed(evt);
            }
        });
        ...
        jMenuItem1.setText("Update Employee");
    ...
    private void emplnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emplnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_emplnActionPerformed
    ...
    private void piidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_piidActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_piidActionPerformed

    private void nameicoeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameicoeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nameicoeActionPerformed
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
        employee mp = new employee(null,true);
            mp.table();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                updateEmp dialog = new updateEmp(new javax.swing.JDialog(), true, emp.getId());
...
public void detail(){
    String a = i;
        try{
                conn = db.db();
                pst = conn.prepareStatement("SELECT * FROM payroll_schema.emp_tbl WHERE emp_id = "+a+";");
                rs = pst.executeQuery();
        ...
        try{
                conn = db.db();
                pst = conn.prepareStatement("SELECT * FROM payroll_schema.pagibig_tbl WHERE emp_id = "+empid.getText()+";");
                rs = pst.executeQuery();
                while(rs.next()){
                    piid.setText(rs.getString("pagibig_id"));
                }
            }catch(Exception e){}
            try{
                conn = db.db();
                pst = conn.prepareStatement("SELECT * FROM payroll_schema.philhealth_tbl WHERE emp_id = "+empid.getText()+";");
                rs = pst.executeQuery();
                while(rs.next()){
                    phid.setText(rs.getString("philhealth_id"));
                }
            }catch(Exception e){}
            try{
                conn = db.db();
                pst = conn.prepareStatement("SELECT * FROM payroll_schema.sss_tbl WHERE emp_id = "+empid.getText()+";");
                rs = pst.executeQuery();
                while(rs.next()){
                    sssid.setText(rs.getString("sss_id"));
                }
            }catch(Exception e){}
            try{
                conn = db.db();
                pst = conn.prepareStatement("SELECT * FROM payroll_schema.tax_tbl WHERE emp_id = "+empid.getText()+";");
                rs = pst.executeQuery();
                while(rs.next()){
                    tinid.setText(rs.getString("tax_id"));
                }
            }catch(Exception e){}
}
}
